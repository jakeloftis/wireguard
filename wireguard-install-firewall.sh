...
PrivateKey = ${SERVER_PRIV_KEY}" >"/etc/wireguard/${SERVER_WG_NIC}.conf"
	...
	if pgrep firewalld; then
		...
		Postup = iptables -t nat -A PREROUTING -i SERVER_PUB_NIC -p udp --dport 51819:65535 -j DNAT --to-destination SERVER_WG_IPV4:51821-65535
		...
		PostDown = iptables -t nat -A PREROUTING -i SERVER_PUB_NIC -p udp --dport 51819:65535 -j DNAT --to-destination SERVER_WG_IPV4:51821-65535" >>"/etc/wireguard/${SERVER_WG_NIC}.conf"
	fi
